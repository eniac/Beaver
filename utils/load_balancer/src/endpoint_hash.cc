...
struct PackedEndpoint f_endpoint_hash(
  ...
  FiveTupleToEndpointMap::iterator five_tuple_map_iter = 
      five_tuple_map.find(five_tuple_key);
  if (five_tuple_map_iter != five_tuple_map.end())
    return five_tuple_map_iter->second;
  
  PackedThreeTupleKey three_tuple_key(five_tuple_key.dst_ip,
                                      five_tuple_key.dst_port,
                                      five_tuple_key.protocol);
