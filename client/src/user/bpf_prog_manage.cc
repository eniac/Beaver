...
int f_bpf_ingress_prog_load(const char *prog_pathname, int if_index) {
  ...
  struct bpf_map *virt_ip_hash_table = bpf_object__find_map_by_name(
                                       prog_obj, "virt_ip_hash_table");
...
int f_bpf_egress_prog_load(const char *prog_pathname, int if_index) {
  ...
  struct bpf_map *lb_ip_array = bpf_object__find_map_by_name(
                                    prog_obj, "lb_ip_array");
  if (lb_ip_array == NULL) {
