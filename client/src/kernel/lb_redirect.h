 ...
 */
static inline __u32
f_lb_index_hash(__u32 src_ip, __u32 dst_ip, __u16 src_port, __u16 dst_port, __u8 protocol, __u16 lb_number)
{
...
static inline __u32
f_port_hash_key_get(__u16 src_port, __u16 dst_port)
{
