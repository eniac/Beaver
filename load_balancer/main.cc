...
int main(int argc, char *argv[]) {
  ...
  for (uint32_t i = 0; i < queue_num_data_plane; i++) {
    struct QueueConfig *queue_config_data_plane = 
        new QueueConfig(mempool_ptr_data_plane, i);
